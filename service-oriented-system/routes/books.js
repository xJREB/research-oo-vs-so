...
router.post("/", middleware.isLoggedIn, function(req,res){
  ...
  var newBook = {name:name, genre:genre, price: price, image:image, description:description, author:author};
0
...
router.put("/:id",middleware.checkBookOwnership,function(req,res){
    var newData   = {name: req.body.name, genre: req.body.genre, image: req.body.image, description: req.body.description, price: req.body.price};
